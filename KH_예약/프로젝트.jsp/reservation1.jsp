...
<head>
    ...
    <link rel="stylesheet" href="../프로젝트css/reservation1.css">
                ...
                <div class="bsh-calender">
                    <div class="bsh-checking in">
                        ...
                        <div id="item_disp_datecal_in" class="pa20">
                            <ul class="year_wrap">
                                <li class="cal_pre"><img src="/images/step_miniarrow.png" alt="이전 달"
                                ...
                                <li class="cal_next"><img src="/images/step_miniarrow" alt="다음 달"
                        ...
                        <div id="item_disp_datecal_out" class="pa20">
                            <ul class="year_wrap">
                                <li class="cal_pre"><img src="/images/step_miniarrow.png" alt="이전 달"
                                        ...
                                        class="cp" style="transform: rotate(180deg)"></li>
                                <li class="cal_year">2022. <span>11</span></li>
                                <li class="cal_next"><img src="/images/step_miniarrow.png" alt="다음 달"
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding-right: 0" class="bsh-zzz">
                                                ...
                                                <p class="age_info ageguide_tip"><a href="javascript:;"><img
                                                            src="/images/iimage.gif" alt="상세정보보기"
