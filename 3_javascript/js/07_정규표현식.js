...
=======
    ...
    // ^(캐럿) : 문자열의 시작을 의미
    const regEx2 = /^group/;
    div1.innerHTML += "/^group/ , group100 : " + regEx2.test("group100") + "<hr>"; // t
    div1.innerHTML += "/^group/ , 100group : " + regEx2.test("100group") + "<hr>"; // f
    
    // ^[abcd] : 문자열이 a,b,c,d 중 하나로 시작하는가?
    const regEx3 = /^[abcd]/;
    div1.innerHTML += "/^[abcd]/ , group : " + regEx3.test("group") + "<hr>"; // f
    div1.innerHTML += "/^[abcd]/ , car : " + regEx3.test("car") + "<hr>"; // t
    div1.innerHTML += "/^[abcd]/ , dark : " + regEx3.test("dark") + "<hr>"; // t
    ...
    // "https://regexr.com/" 여기서 확인
    // ^[ABCD]-team$
    // -> A-team / B-team / C-team / D-team 이 맞으면 true / 아니면 false
    // const regEx5 = /^[ABCD]-team/;
    // div1.innerHTML += "/team$/ , A-team : " + regEx5.test("A-team") + "<hr>"; // t
    // div1.innerHTML += "/team$/ , team-A : " + regEx5.test("team-A") + "<hr>"; // f
>>>>>>> Stashed changes
...
document.getElementById("inputName").addEventListener("keyup",function(){
    ...
    // 유효성 검사
    if( regEx.test(this.value) ){ // 유효하면
        result1.innerText = "유효한 이름형식 입니다.";
        // result1.style.color="green";
    ...
    result1.classList.remove("error");
        ...
        result1.innerHTML = "잘못된 <del>형식</del> 입니다.";
        // result1.style.color="red";
