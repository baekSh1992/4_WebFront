...
function fnTest2(){
    ...
    function fnTest3(){
        ...
        for(let i=0; i<arr.length; i++){
            ...
            arr[i].style.backgroundColor ="rgb(100,"+num+",255)"
        }
    }
        ...
        function fnTest4(){
            ...
            // input 요소에 ""(빈문자열) 대입 ==  값을 삭제 -> 텍스트칸 초기화
            input.value = "";
        }
...
function fnTest6(){
    ...
    document.querySelector("#cssTest").style.border="5px solid green";
