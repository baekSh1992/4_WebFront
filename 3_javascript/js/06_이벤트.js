...
function fnTest1(btn){
    ...
    console.log(btn.style); // 요소에 적용할 수 있는 css 속성 확인(웹 개발자모드)
...
document.getElementById("btn1").onclick = function(){
    ...
    // 한번 클릭 후 이벤트 적용해제 구문 = 원리 : 요소의 속성 중 on이벤트명 속성에 함수 대신 null을 대입하여
    // 이벤트 삭제( 변수에 값을 새로 대입하여 덮어쓰기 하는 원래 )
